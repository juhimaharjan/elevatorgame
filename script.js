window.onload = () => {
  ...
  // Collect prompts and switch to game page when "Play the Game" is clicked
  ...
  // Add event listeners for floor buttons to display prompt
  const buttons = document.querySelectorAll(".btn-floor");
  buttons.forEach(button => {
    button.addEventListener("click", function () {
      const floor = this.getAttribute("data-set-floor");
      const promptMessage = prompts[floor] || "No task provided";
